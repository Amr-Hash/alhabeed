...
def sync_world_cup_tournaments() -> int:
    """Ensure FIFA World Cup tournaments use 48-team rules and football-data.org live scores."""
    ...
    live_config: dict = {"competition_code": "WC"}
    ...
    for tournament in Tournament.objects.filter(
        ...
        if tournament.live_score_provider != Tournament.LiveScoreProvider.FOOTBALL_DATA:
            tournament.live_score_provider = Tournament.LiveScoreProvider.FOOTBALL_DATA
